...
public class AndroidBug5497Workaround {
    ...
    public static void assistActivity(Activity activity, OnInputMethodManagerListener linstener) {
    ...
    private AndroidBug5497Workaround(final Activity activity, final OnInputMethodManagerListener linstener) {
    ...
    private void possiblyResizeChildOfContent(Activity activity, OnInputMethodManagerListener linstener) {
        ...
        if (usableHeightNow != usableHeightPrevious) {
            ...
            if (heightDifference > (usableHeightSansKeyboard / 4)) {
                ...
                if (a == 0) {  //没有系统底部状态栏
                    ...
                    frameLayoutParams.height = usableHeightSansKeyboard - heightDifference;  //  减去 底部导航栏高度
                }
                if (linstener != null) {
     ...
     * 键盘监听接口
     */
    public interface OnInputMethodManagerListener {
        /**
         * 键盘状态接口
         *
         ...
         * @param isShow      是否显示
         */
         void inputMethodCallBack(int inputHeight, boolean isShow);
    }
